...
export function UnitDetailPanel() {
  ...
  const childUnits = unit?.childIds
    ?.map((id) => units[id])
    .filter(Boolean) ?? [];
  ...
  return (
    <Sheet open={isOpen} onOpenChange={(open) => !open && closeDetailPanel()}>
      <SheetContent side="right" showCloseButton={false} className="w-[380px] sm:w-[420px] !p-0 !rounded-none !border-0 w95-font bg-[#c0c0c0]">
        {unit && unitState ? (
          <div className="h-full flex flex-col">
            ...
            <ScrollArea className="flex-1 bg-[#c0c0c0]">
              ...
              <div className="px-3 pb-3 space-y-3">
                ...
                {unit.personnel && (
                  <div className="w95-groupbox">
                    <span className="w95-groupbox-label">Personnel</span>
                    <div className="grid grid-cols-3 gap-1.5 mt-1">
                      <div className="w95-sunken p-1.5 text-center">
                        <div className="text-[9px] text-[#808080] uppercase">Officers</div>
                        <div className="text-[13px] font-bold text-[#000080]">
                          {unit.personnel.officers.toLocaleString()}
                        </div>
                      </div>
                      <div className="w95-sunken p-1.5 text-center">
                        <div className="text-[9px] text-[#808080] uppercase">NCOs</div>
                        <div className="text-[13px] font-bold text-[#806600]">
                          {unit.personnel.ncos.toLocaleString()}
                        </div>
                      </div>
                      <div className="w95-sunken p-1.5 text-center">
                        <div className="text-[9px] text-[#808080] uppercase">Enlisted</div>
                    ...
                    <div className="grid grid-cols-2 gap-1.5 mt-1">
                      {unitState.casualties.killed > 0 && (
                        <div className="w95-sunken p-1.5">
                          <div className="text-[9px] text-[#808080] uppercase">Killed</div>
                      ...
                      {unitState.casualties.wounded > 0 && (
                        <div className="w95-sunken p-1.5">
                          <div className="text-[9px] text-[#808080] uppercase">Wounded</div>
                      ...
                      {unitState.casualties.captured > 0 && (
                        <div className="w95-sunken p-1.5">
                          <div className="text-[9px] text-[#808080] uppercase">Captured</div>
                      ...
                      {unitState.casualties.missing > 0 && (
                        <div className="w95-sunken p-1.5">
                          <div className="text-[9px] text-[#808080] uppercase">Missing</div>
                ...
                {totalCasualties === 0 && (
                  <div className="text-[11px] text-[#808080] italic px-1">
                    No casualties reported at this point in the battle.
                  </div>
                )}
                ...
                {(parentUnit || childUnits.length > 0) && (
                  <div className="w95-groupbox">
                    <span className="w95-groupbox-label">Chain of Command</span>
                    <div className="mt-1">
                      {parentUnit && (
                        <div className="mb-1.5">
                          ...
                          <button
                            onClick={() => openDetailPanel(parentUnit.id)}
                          ...
                          >
                            ...
                            />
                            <span className="text-[11px]">{parentUnit.name}</span>
                          </button>
                        </div>
                      )}
                      {childUnits.length > 0 && (
                        <div>
                          ...
                          <div className="w95-sunken p-1 max-h-[120px] overflow-y-auto">
                            {childUnits.map((child) => (
                              <button
                                key={child.id}
                                onClick={() => openDetailPanel(child.id)}
                ...
                {unit.equipment.length > 0 && (
                  <div className="w95-groupbox">
                    <span className="w95-groupbox-label">Equipment</span>
                    <div className="w95-sunken p-1 mt-1">
                      <table className="w-full">
                        <thead>
                          <tr className="text-[9px] text-[#808080] uppercase border-b border-[#c0c0c0]">
                            <td className="pb-0.5">Name</td>
                            <td className="pb-0.5">Type</td>
                            <td className="pb-0.5 text-right">Qty</td>
                          </tr>
                        </thead>
                        <tbody>
                          {unit.equipment.map((eq, i) => (
                            ...
                            >
                              <td className="py-0.5 font-bold">{eq.name}</td>
                              <td className="py-0.5 text-[#808080]">{eq.category}</td>
                              <td className="py-0.5 text-right font-mono">
                                {eq.quantity.toLocaleString()}
                              </td>
                            </tr>
                          ))}
                        </tbody>
                ...
                {/* History */}
                <div className="w95-groupbox">
                  <span className="w95-groupbox-label">Historical Context</span>
